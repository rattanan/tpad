...
function KpisTab({data,editable}:{data:Workspace;editable:boolean}){
  ...
  const router=useRouter();const [busy,setBusy]=useState('');const [error,setError]=useState('');const [notice,setNotice]=useState('');const [analysis,setAnalysis]=useState<KpiAnalysis|null>(null);const [progress,setProgress]=useState<AiProgress|null>(null);const [elapsed,setElapsed]=useState(0);
