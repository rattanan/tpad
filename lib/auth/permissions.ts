...
export type Permission =
  ...
  | "KPI_VIEW" | "KPI_CREATE" | "KPI_UPDATE" | "KPI_VALIDATE" | "KPI_TEST" | "KPI_REVIEW" | "KPI_APPROVE" | "KPI_CERTIFY"
...
export const rolePermissions: Record<Role, ReadonlySet<Permission>> = {
  ADMIN: new Set(["MANAGE_USERS", "VIEW_LOGIN_HISTORY", "VIEW_AUDIT_LOGS", "MANAGE_DATA_SOURCES", "CREATE_DASHBOARD", "VIEW_DASHBOARD", "EDIT_DASHBOARD", "REVIEW_DASHBOARD", "PUBLISH_DASHBOARD", "MANAGE_DASHBOARD_ACCESS", "EXPORT_DATA", "USE_COPILOT", ...contextView, ...contextManage, ...contextGovern]),
  DATA_SOURCE_CREATOR: new Set(["MANAGE_DATA_SOURCES", "VIEW_DASHBOARD", "USE_COPILOT", ...contextView, ...contextManage]),
  DASHBOARD_CREATOR: new Set(["CREATE_DASHBOARD", "VIEW_DASHBOARD", "EDIT_DASHBOARD", "USE_COPILOT", "BUSINESS_CONTEXT_VIEW", "BUSINESS_OBJECT_VIEW", "BUSINESS_FIELD_VIEW", "BUSINESS_RELATIONSHIP_VIEW", "KPI_VIEW", "BUSINESS_GLOSSARY_VIEW"]),
  VIEWER: new Set(["VIEW_DASHBOARD", "USE_COPILOT", "KPI_VIEW"]),
};
